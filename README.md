...
cleanCGM() output - **/additional**: Folder for output csv of gap
information and percentage expected wear information over the study
output from cleanCGM() - **/graphs**: Folder of CGM trace graphs created
when saveplot=T in cleanCGM() - **/data-….**: Folders for the split
exercise files generated by exercise\_split() [Jump to exercise\_split
output](#exercise_splitoutput) to see list of all folders created for
each split time period
