...
| r_mage                                             | Mean Amplitude Glycemic Excursion. Option to asses average of the differences greater than either  entire dataset SD, 2SD, etc. calculated by the differences between the glucose at the nadirs and peaks, selecting the differences that are >SD of whole dataset and doing the mean of this                                                                                                                                                                                                                     |
